...
export default function LandingPage() {
    return (
        <div className="min-h-screen overflow-x-clip bg-foreground text-white font-sans">
            ...
            <header className="sticky top-0 z-40 border-b border-white/10 bg-foreground">
                <div className="container mx-auto flex h-16 items-center justify-between gap-4 px-4 md:px-8">
                    <div className="flex items-center gap-3">
                        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary text-black font-bold">S</div>
                        <div className="leading-none">
                            <span className="block text-xs uppercase tracking-widest text-white/80">Smetalab</span>
                    ...
                    <details className="group md:hidden">
                        ...
                        <div id="mobile-navigation-panel" className="absolute left-0 right-0 top-16 z-50 border-t border-white/10 bg-foreground shadow-2xl">
            ...
            <main id="main" className="relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 md:px-8 pt-20 pb-16 md:pt-28 md:pb-24">
                        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                            <div className="space-y-8">
                                <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-1 text-xs uppercase tracking-widest text-white/80">
                                    <HardHat className="h-4 w-4 text-primary" aria-hidden="true" />
                                ...
                                <div className="flex flex-wrap items-center gap-6 text-sm text-white/75">
                                    <span className="flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-[var(--color-primary-foreground)]" aria-hidden="true" /> Контроль доступа и аудита</span>
                            ...
                            <div className="relative">
                                <div className="rounded-4xl border border-white/10 bg-white/5 p-6 shadow-[0_40px_120px_rgba(0,0,0,0.45)]">
                                    <div className="flex items-center justify-between text-xs uppercase tracking-widest text-white/75">
                                        <span className="rounded-full bg-foreground px-2 py-0.5 text-white">Project Control</span>
                                        <span className="rounded-full bg-foreground px-2 py-0.5 text-white">Live site</span>
                                    </div>
                                    <div className="mt-6 grid gap-4">
                                        <div className="rounded-2xl border border-white/10 bg-card p-4">
                                            <p className="inline-flex rounded-full bg-foreground px-2 py-0.5 text-xs text-white">Статус участка</p>
                                            <p className="mt-2 font-semibold text-white/95">Жилой комплекс “Северный”. Прогресс: 62%</p>
                                        </div>
                                        <div className="grid gap-4 sm:grid-cols-2">
                                            <div className="rounded-2xl border border-white/10 bg-linear-to-br from-[#FF6A3D]/30 via-[#0B0A0F] to-[var(--color-primary-foreground)]/30 p-4">
                                                <p className="inline-flex rounded-full bg-foreground px-2 py-0.5 text-xs text-white">Бюджет</p>
                                                <div className="mt-4 inline-flex rounded-2xl bg-foreground px-3 py-1 text-2xl font-semibold text-white">84.3 млн ₽</div>
                                                <p className="inline-flex rounded-full bg-foreground px-2 py-0.5 text-xs text-white">Отклонение: −2.1%</p>
                                            </div>
                                            <div className="rounded-2xl border border-white/10 bg-card p-4">
                                            ...
                                            <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-3">
                                                {scheduleFrames.map((frame) => (
                                                    <div key={frame} className="relative h-20 rounded-xl border border-white/10 bg-linear-to-br from-white/10 to-transparent">
                                                        <span className="absolute left-2 top-2 rounded-full bg-foreground px-2 py-0.5 text-xs text-white">{frame}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                ...
                                <div aria-hidden className="absolute -bottom-10 -left-6 h-20 w-40 rounded-full bg-[var(--color-primary-foreground)]/40 blur-3xl animate-pulse" />
                            </div>
                        </div>
                    </div>
                </section>

                <section id="capabilities" className="relative border-t border-white/10 bg-card">
                    <div className="container mx-auto px-4 md:px-8 py-20">
                        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
                            <div className="space-y-6">
                                <span className="text-xs uppercase tracking-widest text-white/75">Capabilities</span>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                {capabilityCards.map((item) => (
                                    <div key={item.title} className="rounded-2xl border border-white/10 bg-card p-5 transition hover:-translate-y-1 hover:border-white/30">
                    ...
                    <div className="container mx-auto px-4 md:px-8 py-20">
                        <div className="flex flex-col gap-10 md:flex-row md:items-center md:justify-between">
                            <div className="space-y-4">
                                <span className="text-xs uppercase tracking-widest text-white/75">Workflow</span>
                ...
                <section id="pricing" className="relative border-t border-white/10 bg-card">
                    <div className="container mx-auto px-4 md:px-8 py-20">
                        <div className="flex flex-col items-start gap-4 md:flex-row md:items-end md:justify-between">
                            <div>
                                <span className="text-xs uppercase tracking-widest text-white/75">Pricing</span>
                        ...
                        <div className="mt-10 grid gap-6 lg:grid-cols-3">
                            {pricingPlans.map((plan) => (
                                <div key={plan.name} className={`rounded-3xl border ${plan.accent ? 'border-primary bg-[#16131A] shadow-[0_30px_80px_rgba(255,106,61,0.2)]' : 'border-white/10 bg-card'} p-6`}>
                                    <span className="text-xs uppercase tracking-widest text-white/75">{plan.name}</span>
                    ...
                    <div className="container mx-auto px-4 md:px-8 py-20">
                        <div className="rounded-4xl border border-white/10 bg-linear-to-br from-[#1B1822] via-[#111017] to-[#0B0A0F] p-10 md:p-14">
                            <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr] md:items-center">
                                <div className="space-y-4 rounded-2xl bg-foreground p-4">
                                    <span className="text-xs uppercase tracking-widest text-white/75">Final Call</span>
            ...
            <footer className="border-t border-white/10 bg-foreground">
                <div className="container mx-auto flex flex-col gap-6 px-4 md:px-8 py-10 md:flex-row md:items-center md:justify-between">
                    <div className="space-y-2">
                        <span className="text-sm uppercase tracking-widest text-white/75">Smetalab BuildOS</span>
