        ...
        <section aria-labelledby="team-title" className="space-y-4 lg:col-span-2">
            ...
            <Card className="glass-card border-border/40 bg-background/50 shadow-sm backdrop-blur-md">
                <CardContent className="space-y-3 p-4">
                    ...
                    <Button variant="outline" className="mt-2 h-9 w-full border-border/40 text-xs font-semibold tracking-tight shadow-sm transition-all active:scale-95 hover:bg-muted/20">
                        Участники
                    </Button>
                </CardContent>
            </Card>
