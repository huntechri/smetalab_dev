...
export function ProjectCard({ project, onDelete, onEdit }: ProjectCardProps) {
    return (
        <Card className="flex flex-col py-0 border-border rounded-[7.6px] bg-white shadow-none transition-colors duration-200 group hover:border-border/60">
            <CardContent className="flex flex-col min-w-0 p-3 sm:p-4 gap-2">
                ...
                <div className="space-y-1">
                    <p className="text-xs text-muted-foreground">Прогресс: {project.progress}%</p>
                    <div
                        role="progressbar"
