        ...
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                {triggerVariant === 'menu-item' ? (
                    ...
                    <Button variant="primary" title="Добавить дополнительную работу" className="gap-1.5 px-3 text-xs font-semibold tracking-tight shadow-sm transition-all active:scale-95 md:text-sm" aria-label="Добавить дополнительную работу">
                ...
                actions={
                    <>
                        <div className="hidden items-center gap-2 sm:flex">
                            <Button variant="outline" className="gap-1.5 text-xs font-semibold tracking-tight shadow-sm transition-all active:scale-95 md:text-sm" onClick={handleExport}>
