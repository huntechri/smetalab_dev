    ...
    <Table className="w-full border-collapse">
      <TableHeader className="sticky top-0 z-20 border-b bg-gray-50/80 backdrop-blur">
        <TableRow className="hover:bg-transparent">
          ...
          {roles.map((role) => (
            <TableHead key={role} className="border-l border-border/60 px-2 py-4 text-center">
              <Badge
                variant="secondary"
        ...
        {permissions.map((perm) => (
          <TableRow key={perm.id} className="border-b transition-colors hover:bg-zinc-50/50">
            ...
            {roles.map((role) => {
              ...
              return (
                <TableCell key={role} className="border-l border-border/40 px-2 py-4">
  ...
  return (
    <div className="space-y-4">
      ...
      <Tabs defaultValue="tenant" className="w-full">
        ...
        <div className="overflow-hidden rounded-[2rem] border-2 border-border/60 bg-white shadow-2xl shadow-zinc-200/50">
