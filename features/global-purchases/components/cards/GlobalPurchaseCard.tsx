    ...
    <DenseCard>
      <div className="grid grid-cols-1 gap-2.5 p-2 sm:p-2.5 lg:grid-cols-[92px_minmax(0,1fr)_minmax(300px,auto)_minmax(150px,220px)_auto] lg:items-center lg:gap-3">
        ...
        <div className="flex flex-wrap items-center gap-1.5 lg:justify-end">
          <div className="inline-flex h-6 whitespace-nowrap items-center gap-1 rounded-full border border-border/60 bg-muted/40 px-1.5 py-0 text-[11px] font-semibold leading-none text-muted-foreground sm:h-5 sm:text-[10px]">
