    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          className="h-6 sm:h-5 max-w-[14rem] sm:max-w-[12rem] justify-start gap-1 rounded-full border border-border/60 bg-slate-50 px-1.5 text-[11px] sm:text-[10px] font-semibold text-slate-700 hover:bg-slate-100"
        >
