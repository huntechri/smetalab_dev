                ...
                {data ? (
                    <FormLayout onSubmit={onSubmit} padding="dialog">
                        <FieldRow label="Название" htmlFor="name">
                            <Input size="default" id="name" value={data.name || ""} onChange={(e) => onFieldChange("name", e.target.value)} required />
                        </FieldRow>
                        ...
                        <FieldRow label="Цена" htmlFor="price">
                            <Input size="default" id="price" type="number" value={data.price || ""} onChange={(e) => onFieldChange("price", e.target.value)} required />
                        </FieldRow>
                        <FieldRow label="Этап" htmlFor="phase">
                            <Input size="default" id="phase" value={data.phase || ""} onChange={(e) => onFieldChange("phase", e.target.value)} />
                        </FieldRow>
                        <FieldRow label="Категория" htmlFor="category">
                            <Input size="default" id="category" value={data.category || ""} onChange={(e) => onFieldChange("category", e.target.value)} />
                        </FieldRow>
                        <FieldRow label="Подкатегория" htmlFor="subcategory">
                            <Input size="default" id="subcategory" value={data.subcategory || ""} onChange={(e) => onFieldChange("subcategory", e.target.value)} />
                        </FieldRow>
                        <DialogFooter>
