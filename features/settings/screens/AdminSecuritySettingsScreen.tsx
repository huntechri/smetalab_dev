      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <FormLayout action={passwordAction}>
            ...
            <Button type="submit" variant="brand" size="default" disabled={isPasswordPending}>{isPasswordPending ? <><Loader2 />Updating...</> : <><Lock />Update Password</>}</Button>
          </FormLayout>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <FormLayout action={deleteAction}>
            ...
            <Button type="submit" variant="destructive" disabled={isDeletePending}>{isDeletePending ? <><Loader2 />Deleting...</> : <><Trash2 />Delete Account</>}</Button>
          </FormLayout>
        </CardContent>
      </Card>
    </WorkspaceMain>
