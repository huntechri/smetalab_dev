        ...
        <div className="p-6">
            ...
            <div>
                <form onSubmit={onSubmit} className="flex flex-col gap-3 sm:flex-row sm:items-end">
                    ...
                    <div className="space-y-1.5 shrink-0">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="outline" className="w-full justify-between sm:w-44 h-9 px-3 gap-1.5 font-semibold tracking-tight shadow-sm transition-all active:scale-95 text-xs md:text-sm">
                                    {getRoleLabel(role)}
                    ...
                    <Button type="submit" variant="primary" disabled={isInviting} className="w-full sm:w-auto h-9 px-3 gap-1.5 font-semibold tracking-tight shadow-sm transition-all active:scale-95 text-xs md:text-sm">
