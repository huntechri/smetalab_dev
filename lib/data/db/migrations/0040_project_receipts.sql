...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "project_receipts_tenant_project_date_idx" ON "project_receipts" USING btree ("tenant_id","project_id","receipt_date") WHERE "project_receipts"."deleted_at" IS NULL;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "project_receipts_tenant_project_status_idx" ON "project_receipts" USING btree ("tenant_id","project_id","status") WHERE "project_receipts"."deleted_at" IS NULL;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "project_receipts_tenant_updated_idx" ON "project_receipts" USING btree ("tenant_id","updated_at" desc) WHERE "project_receipts"."deleted_at" IS NULL;
