...
const buttonVariants = cva(primitiveButtonBaseClassName, {
  variants: {
    variant: {
      ...
      brand: "bg-brand text-brand-foreground shadow-sm hover:bg-brand/90 focus-visible:ring-brand/50 transition-all active:scale-95",
    },
    size: primitiveButtonSizeClassNames,
  },
  defaultVariants: {
    variant: "default",
    size: "xs",
