---
description: Техническая SEO-настройка для Next.js. Создание sitemap.ts, robots.ts и манифеста. Внедрение структурированных данных JSON-LD и настройка metadataBase для корректного индексирования сайта поисковиками.
---
