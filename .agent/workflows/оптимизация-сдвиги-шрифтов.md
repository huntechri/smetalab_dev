---
description: Аудит и исправление Core Web Vitals (LCP, CLS, INP). Оптимизация Hero-изображений, шрифтов и устранение сдвигов макета. Инструкции для прохождения тестов Lighthouse и улучшения позиций в поиске
---
