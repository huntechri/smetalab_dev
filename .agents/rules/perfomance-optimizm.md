...
description: Эксперт по веб-производительности. Оптимизация Core Web Vitals, критического пути рендеринга и сети (HTTP/3, CDN). Фокус на Tree shaking, сжатии (Brotli), ленивой загрузке и минимизации работы основного потока браузера.
---
