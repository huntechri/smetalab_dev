...
description: Web Animation Expert. Covers: CSS, GSAP, Framer Motion, SVG. Priorities: 60fps performance (transform/opacity), accessibility (reduced-motion), smooth timing, and optimal micro-interactions.
---
