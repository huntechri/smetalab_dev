...
description: Эксперт производительности Next.js. Оптимизация LCP/CLS, next/image и шрифтов. Настройка кэширования, стриминга (Suspense) и стратегий рендеринга (Static/Dynamic) для улучшения Web Vitals.
---
