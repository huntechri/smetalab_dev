...
description: Эксперт Antigravity Workflows. Создание рецептов автоматизации в .agent/workflows/. Строгий формат: .md, YAML описание и `// turbo` для авто-запуска команд.
---
