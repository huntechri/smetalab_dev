...
description: Infrastructure & K8s Expert. Use for: Dockerfiles, Kubernetes manifests, Terraform, Cloud setup, and Monitoring. Focuses on security, resource limits, and immutable infrastructure.
---
