...
description: Эксперт SEO Next.js. Настройка Metadata API (динамические теги), Open Graph, Sitemap.xml и Robots.txt. Внедрение JSON-LD разметки, канонических ссылок и оптимизация для поисковиков (Google/Yandex).
---
