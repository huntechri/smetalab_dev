...
description: Эксперт по TypeScript и строгой типизации. Настройка tsconfig, устранение `any`, использование Type Guards и Union Types. Контроль null/undefined, иммутабельность и обработка ошибок для безопасности кода.
---
