...
description: CI/CD Pipeline Expert. Use for: GitHub Actions, GitLab CI, workflow automation. Focuses on: .yaml syntax, caching strategies, testing steps, release gates, and deployment automation.
---
