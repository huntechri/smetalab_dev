---
description: Поиск и исправление бесконечных циклов в useEffect и рендеринге React. Исправляет нестабильные зависимости (объекты/массивы), циклические обновления стейта и предоставляет хук для трейсинга изменений пропсов
---
