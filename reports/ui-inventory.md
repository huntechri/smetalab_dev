...
- app/(admin)/dashboard/tenants/[tenantId]/page.tsx: <Button> size=* => compact-explicit
- app/(admin)/dashboard/tenants/page.tsx: <Button> bare => default-control
- app/(admin)/page.tsx: <Button> size=* => compact-explicit
...
- components/layout/user-menu.tsx: <Button> size=* => compact-explicit
...
- features/auth/components/LoginForm.tsx: <Button> size=* => compact-explicit
...
- features/catalog/components/WorkCatalogPicker.client.tsx: <Button> size=* => compact-explicit
...
- features/global-purchases/components/cards/DeletePurchaseAction.tsx: <Button> size=* => compact-explicit
- features/global-purchases/components/global-purchases-columns.tsx: <Button> size=* => compact-explicit
...
- features/materials/components/MaterialsSidebar.tsx: <Button> size=* => compact-explicit
- features/materials/components/columns.tsx: <Button> size=* => compact-explicit
...
- features/permissions/components/PermissionLevelControl.tsx: <Button> size=* => compact-explicit
...
- features/projects/estimates/components/EstimateHeader.tsx: <Button> size=* => compact-explicit
- features/projects/estimates/components/params/RoomsParamsTable.tsx: <Button> size=* => compact-explicit
- features/projects/estimates/components/params/RoomsParamsTable.tsx: <Input> bare => table-cell
- features/projects/estimates/components/registry/EstimateStatusMenu.tsx: <Button> size=* => compact-explicit
- features/projects/estimates/components/registry/EstimatesListTable.tsx: <Button> size=* => compact-explicit
- features/projects/estimates/components/table/EstimateTable.client.tsx: <Button> bare => table-cell
- features/projects/estimates/components/table/EstimateTableDialogs.tsx: <Button> size=* => compact-explicit
...
- features/projects/estimates/components/table/cards/EstimateMaterialCard.tsx: <Button> size=* => compact-explicit
- features/projects/estimates/components/table/cards/EstimateSectionCard.tsx: <Button> size=* => compact-explicit
- features/projects/estimates/components/table/cards/EstimateWorkCard.tsx: <Button> size=* => compact-explicit
- features/projects/estimates/components/table/columns.tsx: <Button> size=* => compact-explicit
...
- features/projects/list/components/create-project-dialog.tsx: <Button> size=* => compact-explicit
- features/projects/list/components/create-project-dialog.tsx: <Input> bare => default-control
- features/projects/list/components/project-actions.tsx: <Button> size=* => compact-explicit
...
- shared/ui/alert-dialog.tsx: <Button> size=* => compact-explicit
- shared/ui/auto-form/fields/array.tsx: <Button> size=* => compact-explicit
...
- shared/ui/calendar.tsx: <Button> size=* => compact-explicit
- shared/ui/carousel.tsx: <Button> size=* => compact-explicit
...
- shared/ui/search-control.tsx: <Button> size=* => compact-explicit
- shared/ui/search-input.tsx: <Input> size=* => compact-explicit
- shared/ui/sidebar.tsx: <Button> size=* => compact-explicit
- shared/ui/sidebar.tsx: <Input> bare => compact-candidate
- shared/ui/table-actions.tsx: <Button> size=* => compact-explicit
- shared/ui/toolbar-button.tsx: <Button> size=* => compact-explicit
