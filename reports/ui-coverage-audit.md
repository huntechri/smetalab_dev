...
### UI-COVERAGE-050 — P1 — Review UI coverage signals in features/settings/components/user-settings-page.tsx
...
Sample evidence:
- `features/settings/components/user-settings-page.tsx:134` — card-surface-coverage / medium / `Card`
- `features/settings/components/user-settings-page.tsx:176` — icon-action-coverage / low / `Loader2`
- `features/settings/components/user-settings-page.tsx:188` — card-surface-coverage / medium / `Card`
- `features/settings/components/user-settings-page.tsx:199` — card-surface-coverage / medium / `CardContent`
- `features/settings/components/user-settings-page.tsx:268` — card-surface-coverage / medium / `Card`
- `features/settings/components/user-settings-page.tsx:323` — icon-action-coverage / low / `Loader2`
- `features/settings/components/user-settings-page.tsx:335` — card-surface-coverage / medium / `Card`
- `features/settings/components/user-settings-page.tsx:346` — card-surface-coverage / medium / `CardContent`
...
Sample evidence:
- `features/auth/components/LoginForm.tsx:64` — overlay-interaction-coverage / medium / `z-50`
- `features/auth/components/LoginForm.tsx:129` — card-surface-coverage / medium / `CardHeader`
- `features/auth/components/LoginForm.tsx:249` — icon-action-coverage / low / `Loader2`
...
Sample evidence:
- `features/permissions/components/permissions-matrix.tsx:40` — table-toolbar-coverage / medium / `Table`
- `features/permissions/components/permissions-matrix.tsx:41` — overlay-interaction-coverage / medium / `z-20`
- `features/permissions/components/permissions-matrix.tsx:41` — overlay-interaction-coverage / medium / `backdrop-blur`

### UI-COVERAGE-052 — P2 — Review UI coverage signals in features/settings/screens/AdminSecuritySettingsScreen.tsx
...
Sample evidence:
- `features/projects/estimates/components/params/RoomsParamsTable.tsx:88` — card-surface-coverage / medium / `card`
- `features/projects/estimates/components/params/RoomsParamsTable.tsx:89` — table-toolbar-coverage / medium / `Table`
...
Sample evidence:
- `features/dashboard/components/SignalsSection.tsx:27` — card-surface-coverage / medium / `Card`
...
Sample evidence:
- `features/projects/estimates/components/EstimateHeader.tsx:39` — card-surface-coverage / medium / `panel`
...
### UI-COVERAGE-049 — P2 — Review UI coverage signals in features/projects/list/components/projects-sort-select.tsx
...
### UI-COVERAGE-053 — P2 — Review UI coverage signals in features/team/screens/TeamScreen.tsx
...
Sample evidence:
- `features/team/screens/TeamScreen.tsx:49` — card-surface-coverage / medium / `Card`
...
| medium | overlay-interaction-coverage | `features/auth/components/LoginForm.tsx:64` | `z-50` |
| medium | card-surface-coverage | `features/auth/components/LoginForm.tsx:129` | `CardHeader` |
| low | icon-action-coverage | `features/auth/components/LoginForm.tsx:249` | `Loader2` |
...
| low | icon-action-coverage | `features/catalog/components/WorkCatalogPicker.client.tsx:162` | `Plus` |
...
| medium | card-surface-coverage | `features/dashboard/components/SignalsSection.tsx:27` | `Card` |
...
| medium | table-toolbar-coverage | `features/permissions/components/permissions-matrix.tsx:40` | `Table` |
| medium | overlay-interaction-coverage | `features/permissions/components/permissions-matrix.tsx:41` | `z-20` |
| medium | overlay-interaction-coverage | `features/permissions/components/permissions-matrix.tsx:41` | `backdrop-blur` |
| low | icon-action-coverage | `features/projects/dashboard/components/ProjectEstimatesCards.tsx:97` | `Plus` |
| low | icon-action-coverage | `features/projects/dashboard/components/ProjectReceiptsSection.tsx:206` | `Plus` |
| low | icon-action-coverage | `features/projects/estimates/components/CreateEstimateDialog.tsx:128` | `Loader2` |
| medium | card-surface-coverage | `features/projects/estimates/components/EstimateHeader.tsx:39` | `panel` |
| medium | card-surface-coverage | `features/projects/estimates/components/params/RoomsParamsTable.tsx:88` | `card` |
| medium | table-toolbar-coverage | `features/projects/estimates/components/params/RoomsParamsTable.tsx:89` | `Table` |
...
| low | icon-action-coverage | `features/projects/estimates/components/table/EstimateTableToolbar.tsx:128` | `MoreHorizontal` |
...
| low | icon-action-coverage | `features/projects/estimates/components/table/cards/EstimateWorkCard.tsx:127` | `Settings` |
| low | icon-action-coverage | `features/projects/estimates/components/table/columns.tsx:212` | `Settings` |
| low | icon-action-coverage | `features/projects/estimates/components/tabs/EstimateParams.tsx:62` | `Plus` |
| low | icon-action-coverage | `features/projects/estimates/components/tabs/execution/EstimateExecutionAddExtraWorkSheet.tsx:50` | `Plus` |
| low | icon-action-coverage | `features/projects/list/components/create-project-dialog.tsx:271` | `Loader2` |
...
| medium | card-surface-coverage | `features/settings/components/user-settings-page.tsx:134` | `Card` |
| low | icon-action-coverage | `features/settings/components/user-settings-page.tsx:176` | `Loader2` |
| medium | card-surface-coverage | `features/settings/components/user-settings-page.tsx:188` | `Card` |
